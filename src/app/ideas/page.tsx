...
const IDEAS: Idea[] = [
  {
    ...
    sampleKeywords: ['dokter anak depok rekom', 'dokter anak margonda 24 jam', 'dokter anak depok dekat depok'],
  },
  {
    id: 'sekolah-depok',
    category: 'Pendidikan',
    ...
    geoKeywords: ['sekolah depok', 'sd depok', 'smp depok', 'sma depok', 'sekolah depok margonda', 'sekolah depok dekat depok'],
  ...
  },
  {
    ...
    category: 'Kuliner',
    color: '#22c55e',
    title: 'Cafe & Coffee Shop Hits di Depok',
    description: 'Dari kopi susu Rp15rb sampai specialty coffee, dari vibes industrial-garden. Daftar cafe yang lagi rame dan worth it buat nongkrong.',
    whyStrong: 'Kuliner Depok adalah highest search volume category di kawasan. "Cafe depok", "cafe depok", "coffee shop depok" — consistent monthly search. Strong UGC (user generated content) synergy.',
    geoKeywords: ['cafe depok', 'coffee shop depok', 'cafe depok', 'cafe margonda', 'cafe antasari', 'cafe kemang', 'coffee shop depok'],
    sampleKeywords: ['cafe depok aesthetic', 'cafe depok murah', 'cafe depok vibes', 'coffee shop margonda', 'cafe 24 jam depok'],
  },
  {
    ...
    whyStrong: '"Klinik kecantikan depok" dan "skincare clinic depok" high commercial intent — user udah siap booking. Strong affiliate dan partnership potential.',
    geoKeywords: ['klinik kecantikan depok', 'klinik kecantikan depok', 'dermatolog depok', 'skincare clinic kemang', 'beauty clinic antasari'],
  ...
  },
  {
    ...
    whyStrong: '"Gym terdekat", "fitness center depok", " gym depok" high intent. Strong recurring revenue potential (membership partnerships).',
    geoKeywords: ['gym depok', 'fitness center depok', 'gym depok', 'gym antasari', 'gym margonda', 'fitness depok', 'tempat gym dekat depok'],
  ...
  },
  {
    ...
    description: 'Bengkel resmi dan umum, dari service ringan-overhaul. Termasuk rekomendasi montir yang jujur dan tempat yang gak markup parah.',
    ...
    geoKeywords: ['bengkel depok', 'servis mobil depok', 'bengkel mobil depok', 'montir depok', 'bengkel antasari', 'bengkel margonda'],
  ...
  },
  {
    ...
    category: 'Kesehatan',
    color: '#06b6d4',
    title: 'Dokter Gigi & Klinik Gigi di Depok',
    ...
    whyStrong: 'Dental services high commercial intent. "Dokter gigi depok" dan "klinik gigi depok" consistent searches. Strong local pack ranking potential.',
    geoKeywords: ['dokter gigi depok', 'klinik gigi depok', 'dokter gigi margonda', 'behel depok', 'dokter gigi antasari', ' Veneer depok'],
    sampleKeywords: ['dokter gigi depok murah', 'klinik gigi depok rekom', 'scaling depok', 'behel depok'],
  },
  {
    id: 'taman-hiburan',
    category: 'Family',
    ...
    whyStrong: '"Tempat main anak depok", "taman anak depok" high volume, especially weekend. Strong family demographic targeting. Consistent evergreen traffic.',
    geoKeywords: ['taman depok', 'tempat main anak depok', 'indoor playground depok', 'taman kota depok', 'weekend depok keluarga'],
  ...
  },
  {
    ...
    whyStrong: 'Orang tua actively search kursus dan ekskul. "Les privat depok", "bimbel depok" high volume. Strong school-to-program referral traffic.',
    geoKeywords: ['les privat depok', 'bimbel depok', 'kursus anak depok', 'les musik depok', 'ekskul depok', 'bimbel margonda'],
  ...
  },
  {
    ...
    category: 'Kesehatan',
    color: '#dc2626',
    title: 'Rumah Sakit & Fasilitas Kesehatan di Depok',
    ...
    whyStrong: '"Rs depok", "igd 24 jam depok", "rumah sakit depok" emergency searches — highest trust needed. Strong local SEO + structured data opportunity.',
    geoKeywords: ['rumah sakit depok', 'igd depok', 'rs depok', 'klinik 24 jam depok', 'rumah sakit antasari', 'fasilitas kesehatan margonda'],
    sampleKeywords: ['rs depok 24 jam', 'igd terdekat depok', 'rumah sakit depok', 'klinik margonda'],
  },
  {
    id: 'padel-tenis',
    category: 'Olahraga',
    ...
    whyStrong: 'Padel exploding di Jakarta dan Depok. "Lapangan padel depok", "padel depok" trending topic. Very low competition yet, strong first-mover advantage.',
    geoKeywords: ['lapangan padel depok', 'padel depok', 'padel depok', 'court padel depok', 'tennis depok', 'lapangan tennis depok'],
  ...
  },
  {
    ...
    whyStrong: '"Pasar malam depok", "street food depok" high UGC potential. TikTok, Instagram, dan Google Maps synergy strong. Evergreen + seasonal spikes.',
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 960, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <p style={{ fontSize: 16, color: '#64748b', maxWidth: 520, margin: '0 auto', lineHeight: 1.75 }}>
            Topic evergreen dengan GEO & SEO terkuat untuk warga Depok dan Depok. Klik untuk copy keyword, langsung generate article.
          </p>
        </div>
